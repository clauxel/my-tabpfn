...
- Polar hosted checkout with Pro annual selected by default and 50% annual savings.
...
Store the live Polar API key as a Worker or Pages secret named `API_PROD_KEY`.
